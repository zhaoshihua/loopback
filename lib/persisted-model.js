...
module.exports = function(registry) {
  ...
  PersistedModel.setupRemoting = function() {
    ...
    setRemoting(PersistedModel, 'create', {
      description: g.t('Create a new instance of the model and persist it into the data source.'),
      accessType: 'WRITE',
    ...
    var upsertOptions = {
      ...
      description: g.t('Patch an existing model instance or insert a new one ' +
    ...
    setRemoting(PersistedModel, 'exists', {
      description: g.t('Check whether a model instance exists in the data source.'),
      accessType: 'READ',
    ...
    setRemoting(PersistedModel, 'findById', {
      description: g.t('Find a model instance by id from the data source.'),
      accessType: 'READ',
      accepts: [
        { arg: 'id', type: 'any', description: 'Model id', required: true,
          http: { source: 'path' }},
        { arg: 'filter', type: 'object',
          description: g.t('Filter defining fields and include') },
      ],
      returns: { arg: 'data', type: typeName, root: true },
    ...
    setRemoting(PersistedModel, 'find', {
      description: g.t('Find all instances of the model matched by filter from the data source.'),
      accessType: 'READ',
    ...
    setRemoting(PersistedModel, 'findOne', {
      description: g.t('Find first instance of the model matched by filter from the data source.'),
      accessType: 'READ',
      accepts: { arg: 'filter', type: 'object', description:
        'Filter defining fields, where, include, order, offset, and limit' },
      returns: { arg: 'data', type: typeName, root: true },
    ...
    setRemoting(PersistedModel, 'destroyAll', {
      description: g.t('Delete all matching records.'),
      accessType: 'WRITE',
    ...
    setRemoting(PersistedModel, 'updateAll', {
      aliases: ['update'],
      description: g.t('Update instances of the model matched by where from the data source.'),
      accessType: 'WRITE',
      accepts: [
        { arg: 'where', type: 'object', http: { source: 'query' },
          description: 'Criteria to match model instances' },
        { arg: 'data', type: 'object', http: { source: 'body' },
          description: g.t('An object of model property name/value pairs') },
      ],
      returns: {
        arg: 'count',
        description: g.t('The number of instances updated'),
        type: 'object',
        root: true,
      },
    ...
    setRemoting(PersistedModel, 'deleteById', {
      ...
      description: g.t('Delete a model instance by id from the data source.'),
      accessType: 'WRITE',
      accepts: { arg: 'id', type: 'any', description: 'Model id', required: true,
                http: { source: 'path' }},
    ...
    setRemoting(PersistedModel, 'count', {
      description: g.t('Count instances of the model matched by where from the data source.'),
      accessType: 'READ',
    ...
    var updateAttributesOptions = {
      ...
      description: g.t('Patch attributes for a model instance and persist it into ' +
        'the data source.'),
      accessType: 'WRITE',
    ...
    if (options.trackChanges || options.enableRemoteReplication) {
      setRemoting(PersistedModel, 'diff', {
        description: g.t('Get a set of deltas and conflicts since the given checkpoint.'),
        accessType: 'READ',
        accepts: [
      ...
      setRemoting(PersistedModel, 'changes', {
        description: g.t('Get the changes to a model since a given checkpoint.' +
      ...
      setRemoting(PersistedModel, 'checkpoint', {
        description: g.t('Create a checkpoint.'),
      ...
      setRemoting(PersistedModel, 'currentCheckpoint', {
        description: g.t('Get the current checkpoint.'),
        accessType: 'READ',
        returns: { arg: 'checkpoint', type: 'object', root: true },
      ...
      setRemoting(PersistedModel, 'createUpdates', {
        description: g.t('Create an update list from a delta list.'),
      ...
      setRemoting(PersistedModel, 'bulkUpdate', {
        description: g.t('Run multiple updates at once. Note: this is not atomic.'),
        accessType: 'WRITE',
      ...
      setRemoting(PersistedModel, 'findLastChange', {
        description: g.t('Get the most recent change record for this instance.'),
        accessType: 'READ',
        accepts: {
      ...
      setRemoting(PersistedModel, 'updateLastChange', {
        description: [
          g.t('Update the properties of the most recent change record ' +
        ...
        accepts: [
          ...
          {
            arg: 'data', type: 'object', http: { source: 'body' },
            description: g.t('An object of Change property name/value pairs'),
          },
        ],
        returns: { arg: 'result', type: this.Change.modelName, root: true },
    ...
    setRemoting(PersistedModel, 'createChangeStream', {
      description: g.t('Create a change stream.'),
      accessType: 'READ',
      http: [
